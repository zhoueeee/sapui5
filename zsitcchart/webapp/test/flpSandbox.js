		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "withpar ",
									"targetURL": "#zdemowithpar-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zdemowithpar-display": {
								"semanticObject": "zdemowithpar",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zdemowithpar",
									"url": sap.ui.require.toUrl("zdemowithpar")
								}
							}
						}
					}
